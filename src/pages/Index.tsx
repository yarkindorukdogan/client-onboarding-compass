    ...
    <GuideLayout>
      ...
      <div className="mb-8 p-6 bg-muted/30 rounded-lg border">
        ...
        <p className="mb-2">
          ...
          need to work effectively with our client network.
        </p>
        <p>
          Follow the guides below to download the required software, set up your
          PIN code, and learn how to use our intranet resources.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <GuideCard
          ...
          description="Essential applications you need to download and install."
